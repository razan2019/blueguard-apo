...
# 2️⃣ عرض الصفحة المطلوبة
if page == "الرئيسية (Home)":
    # ==========================================
    # ضع هنا كود صفحتك الرئيسية القديم بالكامل
    # ==========================================
    
    # (اتركي باقي كودك الأصلي للرئيسية هنا كما هو دون أي تغيير)

else:
    # ==========================================
    # هنا ينفذ صفحة حرس الحدود
    # ==========================================
    st.title("🛡️ بوابـة حـرس الحـدود والرقابـة الميدانيـة")
    # إذا كان كود الحرس في ملف منفصل يمكنك استدعائه أو لصقه هنا
import pandas as pd
import os
